...
const ApplicationTracker: React.FC = () => {
  ...
  return (
    <div className=" bg-white flex w-full">
      <div className="p-4 bg-gray-50 min-h-screen w-full px-6">
        ...
        <hr />
        <div className="grid grid-cols-4 gap-4 mt-3 sm:grid-cols-1 lg:grid-cols-4">
        ...
        <button
          className="fixed bottom-6 right-6 bg-blue-500 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-600"
          onClick={openModal}
        >
          + Add applicant
        </button>
