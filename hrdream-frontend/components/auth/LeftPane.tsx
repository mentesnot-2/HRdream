export default function LeftPane() {
    return (
        <div className="bg-gray-900 text-white flex flex-col justify-between items-start p-8 min-w-1.5 h-screen sm:w-1/3 pl-16" data-testid="left-pane">
            <div className="flex items-center gap-3" data-testid="brand">
                ...
                <h1 className="text-xl font-bold" data-testid="brand-name">HRdream</h1>
            </div>
            
            <div data-testid="plan-details">
                <h2 className="text-2xl font-bold mb-6" data-testid="plan-title">Plan includes</h2>
                <ul className="flex flex-col items-start gap-2" data-testid="plan-list">
                    {[
                        ...
                        <li key={index} className="flex items-center gap-3" data-testid={`plan-item-${index}`}>
                            <span className="flex items-center justify-center w-5 h-5 bg-blue-500 rounded-full" data-testid={`check-icon-${index}`}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="black"
